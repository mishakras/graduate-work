...
clc
close all
global a1 a2 a3 a4 a5 a6 a7 a8 K model upr
a1 = a11;
a2 = a21;
a3 = a31;
a4 = a41;
...
[t1,THR1] = dip_ode45(@dip_func_model2,[0,600],[1.5;1;0.85],options);
[t2,THR2] = dip_ode45(@dip_func_model2,[0,600],[0.1;0.1;0.85],options);
[t3,THR3] = dip_ode45(@dip_func_model2,[0,600],[0.01;0.01;0.85],options);
figure
hold on
